...
var current = pageChange('home');

document.getElementById('header').innerHTML = '<img src="sloth-logo.svg" id="logo"/>';

document.getElementById('menu').innerHTML = '<a href="#" class="menu">HOME</a><a href="#" class="menu">GAMES</a><a href="#" id="about" class="menu">ABOUT</a>';
